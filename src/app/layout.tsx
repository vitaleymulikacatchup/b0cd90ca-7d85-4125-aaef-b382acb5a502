...
export const metadata: Metadata = {
  title: "Krokodilo Bombardino - Fine Italian Dining",
  description: "Experience authentic Italian cuisine at Krokodilo Bombardino. Award-winning chef, exquisite ambiance, and impeccable service since 1999. Reserve your table today.",
  keywords: ["Italian restaurant", "fine dining", "Italian cuisine", "authentic pasta", "wine selection", "reservations"],
  metadataBase: new URL("https://krokodilo-bombardino.com"),
  alternates: {
    canonical: "https://krokodilo-bombardino.com"
  },
  openGraph: {
    title: "Krokodilo Bombardino - Fine Italian Dining Restaurant",
    description: "Discover exceptional Italian cuisine in an elegant atmosphere. Award-winning chefs and the finest imported ingredients.",
    url: "https://krokodilo-bombardino.com",
    siteName: "Krokodilo Bombardino",
    type: "website",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34kFQ1mvageIxtFsoHwjFOCooyh/uploaded-1765461722534-4bgngwwt.jpg",
      alt: "Elegant dining room at Krokodilo Bombardino"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "Krokodilo Bombardino - Fine Italian Dining",
    description: "Experience authentic Italian cuisine with award-winning chefs and impeccable service.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34kFQ1mvageIxtFsoHwjFOCooyh/uploaded-1765461722534-4bgngwwt.jpg"]
  },
  robots: {
    index: true,
    follow: true
